...
export default function UserEditMode(props) {
  ...
  const saveChanges = async (event) => {
    ...
    setIsUploaded(true);
    let checkEdit = await updateUser(user.idUser, userToEdit);
    if (checkEdit) {
                ...
                <Row className="text-start mb-2">
                  <Col>
                    ...
                    <div className="select">
                      <select name="role" id="role" value={userToEdit.role} required onChange={handleChange}>
